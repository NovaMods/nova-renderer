	...
	namespace polyalloc {
		...
		class allocator_handle {
		  public:
			 ...
			 allocator_handle(char const* const = nullptr) noexcept : allocator_(nullptr) {
			 ...
			 void* allocate(size_t const n, int const flags = 0) {
			 ...
			 void deallocate(void* const p, size_t const n) {
			 ...
			 bool operator==(allocator_handle const& rhs) const {
