...
#pragma region Render engine interface
        ...
        rx::ptr<RhiRenderpass> create_renderpass(const renderpack::RenderPassCreateInfo& data,
        ...
        rx::ptr<RhiSampler> create_sampler(const RhiSamplerCreateInfo& create_info, rx::memory::allocator& allocator) override;

        rx::ptr<RhiImage> create_image(const renderpack::TextureCreateInfo& info, rx::memory::allocator& allocator) override;

        rx::ptr<RhiSemaphore> create_semaphore(rx::memory::allocator& allocator) override;

        rx::vector<rx::ptr<RhiSemaphore>> create_semaphores(uint32_t num_semaphores, rx::memory::allocator& allocator) override;

        rx::ptr<RhiFence> create_fence(bool signaled, rx::memory::allocator& allocator) override;
...
#pragma region Initialization
        ...
        bool does_device_support_extensions(VkPhysicalDevice device, const rx::vector<const char*>& required_device_extensions);
