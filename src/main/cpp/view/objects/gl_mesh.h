...
namespace nova {
    namespace view {
        ...
        public:
            ...
            gl_mesh(model::mesh_definition& definition);
             ...
             */
            void set_data(std::vector<float> data, model::format data_format, usage data_usage);
        ...
        private:
             ...
             */
            void enable_vertex_attributes(model::format data_format);
             ...
             */
            void compute_aabb(std::vector<float> &vertices, model::format data_format);
        };
    }
}
