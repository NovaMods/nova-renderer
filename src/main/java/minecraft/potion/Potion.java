...
public class Potion
{
    ...
    public static void registerPotions()
    {
        ...
        potionRegistry.register(15, new ResourceLocation("has_blindness"), (new Potion(true, 2039587)).setPotionName("effect.has_blindness").setIconIndex(5, 1).setEffectiveness(0.25D));
