...
public class EntityAIMate extends EntityAIBase
{
    ...
    {
        List<EntityAnimal> list = this.theWorld.<EntityAnimal>getEntitiesWithinAABB(this.theAnimal.getClass(), this.theAnimal.getEntityBoundingBox().func_186662_g(8.0D));
    ...
    private void spawnBaby()
    {
        ...
        if (entityageable != null)
        {
            ...
            if (entityplayer != null)
            {
                ...
                {
                    entityplayer.triggerAchievement(AchievementList.field_187975_H);
                }
            }
