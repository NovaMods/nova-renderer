...
{
    private static final Predicate<Entity> field_184553_f = Predicates.and(new Predicate[] {EntitySelectors.NOT_SPECTATING, EntitySelectors.selectAnything, new Predicate<Entity>()
    {
        ...
        if (entity != null)
        {
            ...
            else
            {
                ...
                if (!this.worldObj.isRemote && this.motionX * this.motionX + this.motionY * this.motionY + this.motionZ * this.motionZ < 0.0010000000474974513D)
                {
                    ...
                    {
                        this.entityDropItem(this.func_184550_j(), 0.1F);
                    }
    ...
    {
        Entity entity = null;
        List<Entity> list = this.worldObj.getEntitiesInAABBexcluding(this, this.getEntityBoundingBox().addCoord(this.motionX, this.motionY, this.motionZ).func_186662_g(1.0D), field_184553_f);
        double d0 = 0.0D;
    ...
    public void onCollideWithPlayer(EntityPlayer entityIn)
    {
        if (!this.worldObj.isRemote && this.inGround && this.arrowShake <= 0)
        {
            ...
            if (this.canBePickedUp == EntityArrow.PickupStatus.ALLOWED && !entityIn.inventory.addItemStackToInventory(this.func_184550_j()))
            {
                flag = false;
            }
