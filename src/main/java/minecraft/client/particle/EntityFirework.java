...
public class EntityFirework
{
    ...
    public static class SparkFX extends EntityAnimatedFX
    {
        ...
        public SparkFX(World p_i46465_1_, double p_i46465_2_, double p_i46465_4_, double p_i46465_6_, double p_i46465_8_, double p_i46465_10_, double p_i46465_12_, EffectRenderer p_i46465_14_)
        {
            ...
            this.particleMaxAge = 48 + this.field_187136_p.nextInt(12);
        }
        ...
        public void func_189213_a()
        {
            ...
            {
                EntityFirework.SparkFX entityfirework$sparkfx = new EntityFirework.SparkFX(this.field_187122_b, this.field_187126_f, this.field_187127_g, this.field_187128_h, 0.0D, 0.0D, 0.0D, this.field_92047_az);
                entityfirework$sparkfx.setAlphaF(0.99F);
    ...
    public static class StarterFX extends EntityFX
    {
        ...
        public void func_189213_a()
        {
            ...
            if (this.fireworkAge % 2 == 0 && this.fireworkExplosions != null && this.fireworkAge / 2 < this.fireworkExplosions.tagCount())
            {
                ...
                EntityFirework.OverlayFX entityfirework$overlayfx = new EntityFirework.OverlayFX(this.field_187122_b, this.field_187126_f, this.field_187127_g, this.field_187128_h);
        ...
        private boolean func_92037_i()
        {
            ...
            return minecraft == null || minecraft.getRenderViewEntity() == null || minecraft.getRenderViewEntity().getDistanceSq(this.field_187126_f, this.field_187127_g, this.field_187128_h) >= 256.0D;
        }
        ...
        {
            EntityFirework.SparkFX entityfirework$sparkfx = new EntityFirework.SparkFX(this.field_187122_b, p_92034_1_, p_92034_3_, p_92034_5_, p_92034_7_, p_92034_9_, p_92034_11_, this.theEffectRenderer);
            entityfirework$sparkfx.setAlphaF(0.99F);
            ...
            {
                entityfirework$sparkfx.func_187145_d(p_92034_14_[this.field_187136_p.nextInt(p_92034_14_.length)]);
            }
            ...
            for (int i = -size; i <= size; ++i)
            {
                for (int j = -size; j <= size; ++j)
                {
                    for (int k = -size; k <= size; ++k)
                    {
                        ...
                        double d6 = (double)MathHelper.sqrt_double(d3 * d3 + d4 * d4 + d5 * d5) / speed + this.field_187136_p.nextGaussian() * 0.05D;
        ...
        private void createShaped(double speed, double[][] shape, int[] colours, int[] fadeColours, boolean trail, boolean twinkleIn, boolean p_92038_8_)
        {
            double d0 = shape[0][0];
            double d1 = shape[0][1];
            this.createParticle(this.field_187126_f, this.field_187127_g, this.field_187128_h, d0 * speed, d1 * speed, 0.0D, colours, fadeColours, trail, twinkleIn);
            ...
            for (int i = 0; i < 3; ++i)
            {
                ...
                for (int j = 1; j < shape.length; ++j)
                {
                    ...
                    for (double d8 = 0.25D; d8 <= 1.0D; d8 += 0.25D)
                    {
                        ...
                        {
                            this.createParticle(this.field_187126_f, this.field_187127_g, this.field_187128_h, d9 * d12, d10, d11 * d12, colours, fadeColours, trail, twinkleIn);
                        }
                    }
        ...
        private void createBurst(int[] colours, int[] fadeColours, boolean trail, boolean twinkleIn)
        {
            ...
            for (int i = 0; i < 70; ++i)
            {
                ...
                this.createParticle(this.field_187126_f, this.field_187127_g, this.field_187128_h, d2, d4, d3, colours, fadeColours, trail, twinkleIn);
            }
        }
