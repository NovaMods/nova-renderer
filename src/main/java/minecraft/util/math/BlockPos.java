...
public class BlockPos extends Vec3i
{
    ...
    public static final class MutableBlockPos extends BlockPos
    {
        ...
        {
            this.x += p_185337_1_.getFrontOffsetX();
            this.y += p_185337_1_.getFrontOffsetY();
            this.z += p_185337_1_.getFrontOffsetZ();
        }
    ...
    public static final class PooledMutableBlockPos extends BlockPos
    {
        ...
        {
            return this.set(this.x + p_185341_1_.getFrontOffsetX(), this.y + p_185341_1_.getFrontOffsetY(), this.z + p_185341_1_.getFrontOffsetZ());
        }
    }
}
