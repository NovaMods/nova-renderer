...
public class PathNavigateGround extends PathNavigate
{
    ...
    protected PathFinder getPathFinder()
    {
        ...
        this.nodeProcessor.func_186317_a(true);
            ...
            for (int k = i; k < i + sizeX; ++k)
            {
                for (int l = j; l < j + sizeZ; ++l)
                {
                    ...
                    if (d0 * p_179683_8_ + d1 * p_179683_10_ >= 0.0D)
                    {
                        ...
                        float f = this.theEntity.func_184643_a(pathnodetype);
    ...
    {
        this.nodeProcessor.func_186321_b(canBreakDoors);
    }

    public void setEnterDoors(boolean par1)
    {
        this.nodeProcessor.func_186317_a(par1);
    }

    public boolean getEnterDoors()
    {
        return this.nodeProcessor.func_186323_c();
    }

    public void setCanSwim(boolean canSwim)
    {
        this.nodeProcessor.func_186316_c(canSwim);
    }

    public boolean getCanSwim()
    {
        return this.nodeProcessor.func_186322_e();
    }
