...
public class ItemArmor extends Item
{
    ...
    public Multimap<String, AttributeModifier> getItemAttributeModifiers(EntityEquipmentSlot p_111205_1_)
    {
        ...
        {
            multimap.put(SharedMonsterAttributes.ARMOR.getAttributeUnlocalizedName(), new AttributeModifier(field_185084_n[p_111205_1_.func_188454_b()], "Armor modifier", (double)this.damageReduceAmount, 0));
        }
    ...
    public static enum ArmorMaterial
    {
        ...
        {
            return ItemArmor.maxDamageArray[armorType.func_188454_b()] * this.maxDamageFactor;
        }
