...
public class SetAttributes extends LootFunction
{
    ...
    public ItemStack apply(ItemStack p_186553_1_, Random p_186553_2_, LootContext p_186553_3_)
    {
        for (SetAttributes.Modifier setattributes$modifier : this.field_186561_b)
        {
            ...
            p_186553_1_.func_185129_a(setattributes$modifier.field_186597_b, new AttributeModifier(uuid, setattributes$modifier.field_186596_a, (double)setattributes$modifier.field_186599_d.generateFloat(p_186553_2_), setattributes$modifier.field_186598_c), entityequipmentslot);
        }
    ...
    static class Modifier
    {
        ...
        public static SetAttributes.Modifier func_186586_a(JsonObject p_186586_0_, JsonDeserializationContext p_186586_1_)
        {
            ...
            int i = func_186595_a(JsonUtils.getString(p_186586_0_, "operation"));
            ...
            {
                aentityequipmentslot = new EntityEquipmentSlot[] {EntityEquipmentSlot.func_188451_a(JsonUtils.getString(p_186586_0_, "slot"))};
            }
            else
            {
                ...
                {
                    aentityequipmentslot[j++] = EntityEquipmentSlot.func_188451_a(JsonUtils.getString(jsonelement, "slot"));
                }
        ...
        {
            if (p_186595_0_.equals("addition"))
            {
                return 0;
            }
            else if (p_186595_0_.equals("multiply_base"))
            {
                return 1;
            }
            else if (p_186595_0_.equals("multiply_total"))
            {
                return 2;
            }
            else
    ...
    public static class Serializer extends LootFunction.Serializer<SetAttributes>
    {
        ...
        public SetAttributes func_186530_b(JsonObject p_186530_1_, JsonDeserializationContext p_186530_2_, LootCondition[] p_186530_3_)
        {
            ...
            for (JsonElement jsonelement : jsonarray)
            {
                asetattributes$modifier[i++] = SetAttributes.Modifier.func_186586_a(JsonUtils.getJsonObject(jsonelement, "modifier"), p_186530_2_);
            }
