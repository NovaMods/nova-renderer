...
public class SetDamage extends LootFunction
{
    ...
    {
        if (p_186553_1_.isItemStackDamageable())
        {
            float f = 1.0F - this.field_186566_b.generateFloat(p_186553_2_);
            p_186553_1_.setItemDamage(MathHelper.floor_float(f * (float)p_186553_1_.getMaxDamage()));
        }
        else
        {
            field_186565_a.warn("Couldn\'t set damage of loot item " + p_186553_1_);
        }
