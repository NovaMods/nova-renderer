...
public class BlockStateContainer implements IBlockStatePaletteResizer
{
    ...
    public NibbleArray func_186017_a(byte[] p_186017_1_, NibbleArray p_186017_2_)
    {
        ...
        {
            int j = Block.BLOCK_STATE_IDS.get(this.func_186015_a(i));
            int k = i & 15;
            int l = i >> 8 & 15;
            int i1 = i >> 4 & 15;
    ...
    public void func_186019_a(byte[] p_186019_1_, NibbleArray p_186019_2_, NibbleArray p_186019_3_)
    {
        for (int i = 0; i < 4096; ++i)
        {
            int j = i & 15;
            ...
            this.func_186014_b(i, (IBlockState)Block.BLOCK_STATE_IDS.getByValue(j1));
        }
    }

    public int func_186018_a()
    {
        int i = this.field_186021_b.func_188144_b();
