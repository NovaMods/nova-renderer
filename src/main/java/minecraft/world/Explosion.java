...
public class Explosion
{
            ...
            if (!entity.isImmuneToExplosions())
            {
                ...
                if (d12 <= 1.0D)
                {
                    ...
                    if (d13 != 0.0D)
                    {
                        ...
                        entity.attackEntityFrom(DamageSource.setExplosionSource(this), (float)((int)((d10 * d10 + d10) / 2.0D * 7.0D * (double)f3 + 1.0D)));
                        double d11 = 1.0D;
    ...
    {
        this.worldObj.func_184148_a((EntityPlayer)null, this.explosionX, this.explosionY, this.explosionZ, SoundEvents.entity_generic_explode, SoundCategory.BLOCKS, 4.0F, (1.0F + (this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) * 0.2F) * 0.7F);
