...
public class TileEntityHopper extends TileEntityLockableLoot implements IHopper, ITickable
{
    ...
    public static boolean captureDroppedItems(IHopper p_145891_0_)
    {
        ...
        {
            for (EntityItem entityitem : func_184292_a(p_145891_0_.getWorld(), p_145891_0_.getXPos(), p_145891_0_.getYPos(), p_145891_0_.getZPos()))
            {
    ...
    {
        return p_184292_0_.<EntityItem>getEntitiesWithinAABB(EntityItem.class, new AxisAlignedBB(p_184292_1_ - 0.5D, p_184292_3_, p_184292_5_ - 0.5D, p_184292_1_ + 0.5D, p_184292_3_ + 1.5D, p_184292_5_ + 0.5D), EntitySelectors.selectAnything);
    }
