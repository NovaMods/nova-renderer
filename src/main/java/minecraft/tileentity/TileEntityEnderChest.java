...
public class TileEntityEnderChest extends TileEntity implements ITickable
{
    ...
    public void update()
    {
        ...
        if (this.numPlayersUsing > 0 && this.lidAngle == 0.0F)
        {
            ...
            this.worldObj.func_184148_a((EntityPlayer)null, d0, (double)j + 0.5D, d1, SoundEvents.block_enderchest_open, SoundCategory.BLOCKS, 0.5F, this.worldObj.rand.nextFloat() * 0.1F + 0.9F);
        }
        ...
        if (this.numPlayersUsing == 0 && this.lidAngle > 0.0F || this.numPlayersUsing > 0 && this.lidAngle < 1.0F)
        {
            ...
            if (this.lidAngle < f1 && f2 >= f1)
            {
                ...
                this.worldObj.func_184148_a((EntityPlayer)null, d3, (double)j + 0.5D, d2, SoundEvents.block_enderchest_close, SoundCategory.BLOCKS, 0.5F, this.worldObj.rand.nextFloat() * 0.1F + 0.9F);
            }
