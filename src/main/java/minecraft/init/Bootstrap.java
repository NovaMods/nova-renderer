...
public class Bootstrap
{
    ...
    static void registerDispenserBehaviors()
    {
        ...
        {
            protected IProjectile getProjectileEntity(World worldIn, IPosition position, ItemStack p_82499_3_)
            {
        ...
        BlockDispenser.dispenseBehaviorRegistry.putObject(Items.spawn_egg, new BehaviorDefaultDispenseItem()
        {
            public ItemStack dispenseStack(IBlockSource source, ItemStack stack)
            {
                ...
                Entity entity = ItemMonsterPlacer.spawnCreature(source.getWorld(), ItemMonsterPlacer.func_185080_h(stack), d0, d1, d2);
                ...
                ItemMonsterPlacer.func_185079_a(source.getWorld(), (EntityPlayer)null, stack, entity);
                stack.splitStack(1);
                return stack;
            }
        });
        ...
        BlockDispenser.dispenseBehaviorRegistry.putObject(Item.getItemFromBlock(Blocks.tnt), new BehaviorDefaultDispenseItem()
        {
            protected ItemStack dispenseStack(IBlockSource source, ItemStack stack)
            {
                ...
                world.func_184148_a((EntityPlayer)null, entitytntprimed.posX, entitytntprimed.posY, entitytntprimed.posZ, SoundEvents.entity_tnt_primed, SoundCategory.BLOCKS, 1.0F, 1.0F);
                --stack.stackSize;
                return stack;
            }
        });
    ...
    public static class BehaviorDispenseBoat extends BehaviorDefaultDispenseItem
    {
        ...
        public ItemStack dispenseStack(IBlockSource source, ItemStack stack)
        {
            ...
            entityboat.rotationYaw = enumfacing.getOpposite().func_185119_l();
