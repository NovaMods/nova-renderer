...
public class BlockFenceGate extends BlockHorizontal
{
    ...
    public AxisAlignedBB func_185496_a(IBlockState state, IBlockAccess source, BlockPos pos)
    {
        ...
        return ((Boolean)state.getValue(IN_WALL)).booleanValue() ? (((EnumFacing)state.getValue(FACING)).getAxis() == EnumFacing.Axis.X ? field_185544_g : field_185543_f) : (((EnumFacing)state.getValue(FACING)).getAxis() == EnumFacing.Axis.X ? field_185542_e : field_185541_d);
    }
    ...
    {
        return ((Boolean)worldIn.getValue(OPEN)).booleanValue() ? NULL_AABB : (((EnumFacing)worldIn.getValue(FACING)).getAxis() == EnumFacing.Axis.Z ? field_185539_B : field_185540_C);
    }
