...
public class BlockPressurePlate extends BlockBasePressurePlate
{
    ...
    protected void func_185507_b(World p_185507_1_, BlockPos p_185507_2_)
    {
        ...
        {
            p_185507_1_.func_184133_a((EntityPlayer)null, p_185507_2_, SoundEvents.block_wood_pressplate_click_on, SoundCategory.BLOCKS, 0.3F, 0.8F);
        }
        else
        {
            p_185507_1_.func_184133_a((EntityPlayer)null, p_185507_2_, SoundEvents.block_stone_pressplate_click_on, SoundCategory.BLOCKS, 0.3F, 0.6F);
        }
    }
    ...
    protected void func_185508_c(World p_185508_1_, BlockPos p_185508_2_)
    {
        if (this.blockMaterial == Material.wood)
        {
            p_185508_1_.func_184133_a((EntityPlayer)null, p_185508_2_, SoundEvents.block_wood_pressplate_click_off, SoundCategory.BLOCKS, 0.3F, 0.7F);
        }
        else
        {
            p_185508_1_.func_184133_a((EntityPlayer)null, p_185508_2_, SoundEvents.block_stone_pressplate_click_off, SoundCategory.BLOCKS, 0.3F, 0.5F);
        }
    }

    protected int computeRedstoneStrength(World worldIn, BlockPos pos)
    {
        AxisAlignedBB axisalignedbb = field_185511_c.offset(pos);
