...
public class BlockChest extends BlockContainer
{
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand side, ItemStack hitX, EnumFacing hitY, float hitZ, float p_180639_9_, float p_180639_10_)
    {
        ...
        else
        {
            ...
            if (ilockablecontainer != null)
            {
                ...
                {
                    playerIn.triggerAchievement(StatList.field_188063_ac);
                }
                else if (this.chestType == BlockChest.Type.TRAP)
                {
                    playerIn.triggerAchievement(StatList.field_188089_W);
                }
            }
    ...
    {
        return side == EnumFacing.UP ? worldIn.getWeakPower(pos, state, side) : 0;
    }
    ...
    {
        return Container.calcRedstoneFromInventory(this.getLockableContainer(pos, p_180641_3_));
    }
