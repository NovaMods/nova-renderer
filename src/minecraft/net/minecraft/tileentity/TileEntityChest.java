...
public class TileEntityChest extends TileEntityLockableLoot implements ITickable, IInventory
{
    ...
    public void update()
    {
        ...
        if (this.numPlayersUsing > 0 && this.lidAngle == 0.0F && this.adjacentChestZNeg == null && this.adjacentChestXNeg == null)
        {
            ...
            this.worldObj.func_184148_a((EntityPlayer)null, d1, (double)j + 0.5D, d2, SoundEvents.block_chest_open, SoundCategory.BLOCKS, 0.5F, this.worldObj.rand.nextFloat() * 0.1F + 0.9F);
        }
        ...
        if (this.numPlayersUsing == 0 && this.lidAngle > 0.0F || this.numPlayersUsing > 0 && this.lidAngle < 1.0F)
        {
            ...
            if (this.lidAngle < f3 && f2 >= f3 && this.adjacentChestZNeg == null && this.adjacentChestXNeg == null)
            {
                ...
                this.worldObj.func_184148_a((EntityPlayer)null, d3, (double)j + 0.5D, d0, SoundEvents.block_chest_close, SoundCategory.BLOCKS, 0.5F, this.worldObj.rand.nextFloat() * 0.1F + 0.9F);
            }
    ...
    {
        this.lootTable = p_184287_1_;
        this.lootTableSeed = p_184287_2_;
    }
}
