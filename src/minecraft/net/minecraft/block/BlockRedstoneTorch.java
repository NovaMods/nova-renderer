...
public class BlockRedstoneTorch extends BlockTorch
{
    ...
    {
        return this.isOn && worldIn.getValue(FACING) != side ? 15 : 0;
    }
    ...
    public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand)
    {
        ...
        if (this.isOn)
        {
            if (flag)
            {
                ...
                {
                    worldIn.func_184133_a((EntityPlayer)null, pos, SoundEvents.block_redstone_torch_burnout, SoundCategory.BLOCKS, 0.5F, 2.6F + (worldIn.rand.nextFloat() - worldIn.rand.nextFloat()) * 0.8F);
    ...
    {
        return side == EnumFacing.DOWN ? worldIn.getWeakPower(pos, state, side) : 0;
    }
