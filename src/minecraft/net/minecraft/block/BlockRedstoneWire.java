...
public class BlockRedstoneWire extends Block
{
    ...
    {
        return field_185700_f[func_185699_x(state.getActualState(source, pos))];
    }
    ...
    {
        return worldIn.getBlockState(pos.down()).func_185896_q() || worldIn.getBlockState(pos.down()).getBlock() == Blocks.glowstone;
    }
    ...
    {
        return !this.canProvidePower ? 0 : worldIn.getWeakPower(pos, state, side);
    }
    ...
    public int getWeakPower(IBlockState worldIn, IBlockAccess pos, BlockPos state, EnumFacing side)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                for (EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL)
                {
                    if (this.func_176339_d(pos, state, enumfacing))
                    {
