...
public class BlockFurnace extends BlockContainer
{
    ...
    public void randomDisplayTick(IBlockState worldIn, World pos, BlockPos state, Random rand)
    {
        if (this.isBurning)
        {
            ...
            {
                pos.func_184134_a((double)state.getX() + 0.5D, (double)state.getY(), (double)state.getZ() + 0.5D, SoundEvents.block_furnace_fire_crackle, SoundCategory.BLOCKS, 1.0F, 1.0F, false);
            }
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand side, ItemStack hitX, EnumFacing hitY, float hitZ, float p_180639_9_, float p_180639_10_)
    {
        ...
        else
        {
            ...
            if (tileentity instanceof TileEntityFurnace)
            {
                ...
                playerIn.triggerAchievement(StatList.field_188061_aa);
            }
