...
public abstract class TabCompleter
{
    ...
    public void func_186841_a()
    {
        ...
        {
            this.field_186844_a.deleteFromCursor(this.field_186844_a.func_146197_a(-1, this.field_186844_a.getCursorPosition(), false) - this.field_186844_a.getCursorPosition());
        ...
        {
            int i = this.field_186844_a.func_146197_a(-1, this.field_186844_a.getCursorPosition(), false);
        ...
        this.field_186844_a.writeText((String)this.field_186849_f.get(this.field_186848_e++));
    }
    ...
    private void func_186838_a(String p_186838_1_)
    {
        ...
        {
            Minecraft.getMinecraft().thePlayer.sendQueue.addToSendQueue(new CPacketTabComplete(p_186838_1_, this.func_186839_b(), this.field_186845_b));
    ...
    public void func_186840_a(String[] p_186840_1_)
    {
        if (this.field_186847_d)
        {
            ...
            String s1 = this.field_186844_a.getText().substring(this.field_186844_a.func_146197_a(-1, this.field_186844_a.getCursorPosition(), false));
