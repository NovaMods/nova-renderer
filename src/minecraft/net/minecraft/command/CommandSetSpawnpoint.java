...
public class CommandSetSpawnpoint extends CommandBase
{
    ...
    {
        return args.length == 1 ? getListOfStringsMatchingLastWord(args, server.getAllUsernames()) : (args.length > 1 && args.length <= 4 ? func_175771_a(args, 1, pos) : Collections.<String>emptyList());
    }
