...
public class CommandSpreadPlayers extends CommandBase
{
    ...
    private void func_110669_a(ICommandSender p_110669_1_, List<Entity> p_110669_2_, CommandSpreadPlayers.Position p_110669_3_, double p_110669_4_, double p_110669_6_, World worldIn, boolean p_110669_9_) throws CommandException
    {
        ...
        {
            p_110669_1_.addChatMessage(new TextComponentTranslation("commands.spreadplayers.info." + (p_110669_9_ ? "teams" : "players"), new Object[] {String.format("%.2f", new Object[]{Double.valueOf(d4)}), Integer.valueOf(i)}));
        }
    }
    ...
    {
        return args.length >= 1 && args.length <= 2 ? func_181043_b(args, 0, pos) : Collections.<String>emptyList();
    }
