...
{
    private static final DataParameter<Integer> field_184741_a = EntityDataManager.<Integer>createKey(EntityWither.class, DataSerializers.VARINT);
    private static final DataParameter<Integer> field_184742_b = EntityDataManager.<Integer>createKey(EntityWither.class, DataSerializers.VARINT);
    private static final DataParameter<Integer> field_184743_c = EntityDataManager.<Integer>createKey(EntityWither.class, DataSerializers.VARINT);
    ...
    private final BossInfoServer field_184744_bE = (BossInfoServer)(new BossInfoServer(this.getDisplayName(), BossInfo.Color.PURPLE, BossInfo.Overlay.PROGRESS)).setDarkenSky(true);
    ...
    {
        super.entityInit();
        this.dataWatcher.register(field_184741_a, Integer.valueOf(0));
        this.dataWatcher.register(field_184742_b, Integer.valueOf(0));
        this.dataWatcher.register(field_184743_c, Integer.valueOf(0));
    ...
    protected void updateAITasks()
    {
        ...
        else
        {
            ...
            this.field_184744_bE.setPercent(this.getHealth() / this.getMaxHealth());
        }
    }
    ...
    public void func_184178_b(EntityPlayerMP p_184178_1_)
    {
        ...
        this.field_184744_bE.addPlayer(p_184178_1_);
    }

    public void func_184203_c(EntityPlayerMP p_184203_1_)
    {
        super.func_184203_c(p_184203_1_);
        this.field_184744_bE.removePlayer(p_184203_1_);
    }
    ...
    protected void dropFewItems(boolean wasRecentlyHit, int lootingModifier)
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                entityplayer.triggerAchievement(AchievementList.field_187977_J);
            }
        }
    }
    ...
    {
        return ((Integer)this.dataWatcher.get(field_184745_bv[p_82203_1_])).intValue();
    }
    ...
    {
        this.dataWatcher.set(field_184745_bv[targetOffset], Integer.valueOf(newId));
    }
