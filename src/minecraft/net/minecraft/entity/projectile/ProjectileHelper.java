...
public final class ProjectileHelper
{
    public static RayTraceResult func_188802_a(Entity p_188802_0_, boolean p_188802_1_, boolean p_188802_2_, Entity p_188802_3_)
    {
        ...
        if (p_188802_1_)
        {
            ...
            Entity entity = null;
            List<Entity> list = world.getEntitiesWithinAABBExcludingEntity(p_188802_0_, p_188802_0_.getEntityBoundingBox().addCoord(d3, d4, d5).func_186662_g(1.0D));
            double d6 = 0.0D;
            ...
            for (int i = 0; i < list.size(); ++i)
            {
                ...
                {
                    AxisAlignedBB axisalignedbb = entity1.getEntityBoundingBox().func_186662_g(0.30000001192092896D);
