...
public class EntityOcelot extends EntityTameable
{
    ...
    public boolean func_184645_a(EntityPlayer p_184645_1_, EnumHand p_184645_2_, ItemStack p_184645_3_)
    {
        ...
        else if ((this.aiTempt == null || this.aiTempt.isRunning()) && p_184645_3_ != null && p_184645_3_.getItem() == Items.fish && p_184645_1_.getDistanceSqToEntity(this) < 9.0D)
        {
    ...
    {
        if (this.worldObj.checkNoEntityCollision(this.getEntityBoundingBox(), this) && this.worldObj.func_184144_a(this, this.getEntityBoundingBox()).isEmpty() && !this.worldObj.isAnyLiquid(this.getEntityBoundingBox()))
        {
