...
public class EntityList
{
    ...
    static
    {
        ...
        addMapping(EntityMinecartEmpty.class, EntityMinecart.Type.RIDEABLE.func_184954_b(), 42);
        addMapping(EntityMinecartChest.class, EntityMinecart.Type.CHEST.func_184954_b(), 43);
        addMapping(EntityMinecartFurnace.class, EntityMinecart.Type.FURNACE.func_184954_b(), 44);
        addMapping(EntityMinecartTNT.class, EntityMinecart.Type.TNT.func_184954_b(), 45);
        addMapping(EntityMinecartHopper.class, EntityMinecart.Type.HOPPER.func_184954_b(), 46);
        addMapping(EntityMinecartMobSpawner.class, EntityMinecart.Type.SPAWNER.func_184954_b(), 47);
        addMapping(EntityMinecartCommandBlock.class, EntityMinecart.Type.COMMAND_BLOCK.func_184954_b(), 40);
