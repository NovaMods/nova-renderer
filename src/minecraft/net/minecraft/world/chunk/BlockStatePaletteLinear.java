...
public class BlockStatePaletteLinear implements IBlockStatePalette
{
    ...
    {
        this.field_186045_d = p_186038_1_.readVarIntFromBuffer();

        for (int i = 0; i < this.field_186045_d; ++i)
        {
            this.field_186042_a[i] = (IBlockState)Block.BLOCK_STATE_IDS.getByValue(p_186038_1_.readVarIntFromBuffer());
        }
    }
