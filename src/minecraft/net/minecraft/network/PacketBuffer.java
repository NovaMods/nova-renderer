...
public class PacketBuffer extends ByteBuf
{
    ...
    {
        this.writeVarIntToBuffer(p_186875_1_.length);

        for (int i = 0; i < p_186875_1_.length; ++i)
        {
            this.writeVarIntToBuffer(p_186875_1_[i]);
        }
    ...
    {
        this.writeVarIntToBuffer(p_186865_1_.length);

        for (int i = 0; i < p_186865_1_.length; ++i)
        {
            this.writeLong(p_186865_1_[i]);
        }

        return this;
    }

    public long[] func_186873_b(long[] p_186873_1_)
    {
        int i = this.readVarIntFromBuffer();

        if (p_186873_1_ == null || p_186873_1_.length != i)
        {
            p_186873_1_ = new long[i];
        }

        for (int j = 0; j < p_186873_1_.length; ++j)
        {
            p_186873_1_[j] = this.readLong();
        }
