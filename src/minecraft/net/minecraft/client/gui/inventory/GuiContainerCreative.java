...
public class GuiContainerCreative extends InventoryEffectRenderer
{
    ...
    protected void func_184098_a(Slot p_184098_1_, int p_184098_2_, int p_184098_3_, ClickType p_184098_4_)
    {
        ...
        if (p_184098_1_ == null && selectedTabIndex != CreativeTabs.tabInventory.getTabIndex() && p_184098_4_ != ClickType.QUICK_CRAFT)
        {
        ...
        else if (selectedTabIndex == CreativeTabs.tabInventory.getTabIndex())
        {
            ...
            else if (p_184098_4_ == ClickType.THROW && this.mc.thePlayer.inventory.getItemStack() != null)
            {
            ...
            {
                this.mc.thePlayer.inventoryContainer.func_184996_a(p_184098_1_ == null ? p_184098_2_ : ((GuiContainerCreative.CreativeSlot)p_184098_1_).slot.slotNumber, p_184098_3_, p_184098_4_, this.mc.thePlayer);
                this.mc.thePlayer.inventoryContainer.detectAndSendChanges();
            }
        }
        else if (p_184098_4_ != ClickType.QUICK_CRAFT && p_184098_1_.inventory == field_147060_v)
        {
            InventoryPlayer inventoryplayer = this.mc.thePlayer.inventory;
            ItemStack itemstack1 = inventoryplayer.getItemStack();
            ItemStack itemstack2 = p_184098_1_.getStack();
            ...
            if (p_184098_4_ == ClickType.SWAP)
            {
                if (itemstack2 != null && p_184098_3_ >= 0 && p_184098_3_ < 9)
                {
                    ...
                    this.mc.thePlayer.inventory.setInventorySlotContents(p_184098_3_, itemstack7);
                    this.mc.thePlayer.inventoryContainer.detectAndSendChanges();
                }
            ...
            {
                if (inventoryplayer.getItemStack() == null && p_184098_1_.getHasStack())
                {
                    ItemStack itemstack6 = p_184098_1_.getStack().copy();
            ...
            if (p_184098_4_ == ClickType.THROW)
            {
                if (itemstack2 != null)
                {
                    ...
                    itemstack3.stackSize = p_184098_3_ == 0 ? 1 : itemstack3.getMaxStackSize();
        ...
        {
            this.inventorySlots.func_184996_a(p_184098_1_ == null ? p_184098_2_ : p_184098_1_.slotNumber, p_184098_3_, p_184098_4_, this.mc.thePlayer);
