...
public class GlStateManager
{
    ...
    public static void glBlendEquation(int p_187398_0_)
    {
    ...
    public static void setFog(GlStateManager.FogMode p_187430_0_)
    {
        setFog(p_187430_0_.field_187351_d);
    }
    ...
    {
        cullFace(p_187407_0_.field_187328_d);
    }
    ...
    public static void glPolygonMode(int p_187409_0_, int p_187409_1_)
    {
    ...
    public static void colorLogicOp(GlStateManager.LogicOp p_187422_0_)
    {
        colorLogicOp(p_187422_0_.field_187370_q);
    }
