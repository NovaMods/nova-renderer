        ...
        if (entity.getBlock() != null)
        {
            ...
            if (iblockstate.getRenderType() == EnumBlockRenderType.MODEL)
            {
                ...
                if (iblockstate != world.getBlockState(new BlockPos(entity)) && iblockstate.getRenderType() != EnumBlockRenderType.INVISIBLE)
                {
                    ...
                    blockrendererdispatcher.getBlockModelRenderer().renderModel(world, blockrendererdispatcher.func_184389_a(iblockstate), iblockstate, blockpos, vertexbuffer, false, MathHelper.getPositionRandom(entity.func_184531_j()));
                    tessellator.draw();
