...
public class RenderManager
{
    ...
    {
        return this.getEntityRenderObject(p_188390_1_).func_188295_H_();
    }
    ...
    public void func_188388_a(Entity p_188388_1_, float p_188388_2_, boolean p_188388_3_)
    {
        ...
        this.func_188391_a(p_188388_1_, d0 - this.renderPosX, d1 - this.renderPosY, d2 - this.renderPosZ, f, p_188388_2_, p_188388_3_);
    }
    ...
    public void func_188391_a(Entity p_188391_1_, double p_188391_2_, double p_188391_4_, double p_188391_6_, float p_188391_8_, float p_188391_9_, boolean p_188391_10_)
    {
        ...
        try
        {
            render = this.<Entity>getEntityRenderObject(p_188391_1_);

            if (render != null && this.renderEngine != null)
            {
                try
                {
                    render.func_188297_a(this.renderOutlines);
                ...
                if (this.debugBoundingBox && !p_188391_1_.isInvisible() && !p_188391_10_)
                {
                    try
                    {
        ...
        catch (Throwable throwable3)
        {
            ...
            p_188391_1_.addEntityCrashInfo(crashreportcategory);
            ...
            crashreportcategory1.addCrashSection("Rotation", Float.valueOf(p_188391_8_));
            crashreportcategory1.addCrashSection("Delta", Float.valueOf(p_188391_9_));
    ...
    public void func_188389_a(Entity p_188389_1_, float p_188389_2_)
    {
        ...
        if (render != null && this.renderEngine != null)
        {
            render.func_188300_b(p_188389_1_, d0 - this.renderPosX, d1 - this.renderPosY, d2 - this.renderPosZ, f, p_188389_2_);
        }
    }
