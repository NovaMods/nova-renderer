...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void handleSpawnObject(SPacketSpawnObject packetIn)
    {
        ...
        {
            entity = EntityMinecart.func_184263_a(this.clientWorldController, d0, d1, d2, EntityMinecart.Type.func_184955_a(packetIn.getData()));
        }
    ...
    public void handleCollectItem(SPacketCollectItem packetIn)
    {
        ...
        if (entity != null)
        {
            ...
            {
                this.clientWorldController.func_184134_a(entity.posX, entity.posY, entity.posZ, SoundEvents.entity_experience_orb_pickup, SoundCategory.PLAYERS, 0.2F, ((this.avRandomizer.nextFloat() - this.avRandomizer.nextFloat()) * 0.7F + 1.0F) * 2.0F, false);
            }
            else
            {
                this.clientWorldController.func_184134_a(entity.posX, entity.posY, entity.posZ, SoundEvents.entity_item_pickup, SoundCategory.PLAYERS, 0.2F, ((this.avRandomizer.nextFloat() - this.avRandomizer.nextFloat()) * 0.7F + 1.0F) * 2.0F, false);
            }
    ...
    public void handleOpenWindow(SPacketOpenWindow packetIn)
    {
        ...
        else if ("EntityHorse".equals(packetIn.getGuiId()))
        {
            ...
            {
                entityplayersp.func_184826_a((EntityHorse)entity, new AnimalChest(packetIn.getWindowTitle(), packetIn.getSlotCount()));
                entityplayersp.openContainer.windowId = packetIn.getWindowId();
            }
        }
    ...
    public void handleChangeGameState(SPacketChangeGameState packetIn)
    {
        ...
        {
            this.clientWorldController.func_184148_a(entityplayer, entityplayer.posX, entityplayer.posY + (double)entityplayer.getEyeHeight(), entityplayer.posZ, SoundEvents.entity_arrow_hit_player, SoundCategory.PLAYERS, 0.18F, 0.45F);
        }
        else if (i == 7)
        {
        ...
        else if (i == 10)
        {
            ...
            this.clientWorldController.func_184148_a(entityplayer, entityplayer.posX, entityplayer.posY, entityplayer.posZ, SoundEvents.entity_elder_guardian_curse, SoundCategory.HOSTILE, 1.0F, 1.0F);
        }
    }
    ...
    public void handleStatistics(SPacketStatistics packetIn)
    {
        ...
        {
            this.gameController.guiAchievement.displayUnformattedAchievement(AchievementList.field_187982_f);
        }
    ...
    public void handleTabComplete(SPacketTabComplete packetIn)
    {
        ...
        {
            ((ITabCompleter)this.gameController.currentScreen).func_184072_a(astring);
        }
    }
    ...
    {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        this.gameController.theWorld.func_184148_a(this.gameController.thePlayer, packetIn.getX(), packetIn.getY(), packetIn.getZ(), packetIn.getSound(), packetIn.getCategory(), packetIn.getVolume(), packetIn.getPitch());
    }

    public void handleCustomSound(SPacketCustomSound packetIn)
    {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        this.gameController.getSoundHandler().playSound(new PositionedSoundRecord(new ResourceLocation(packetIn.getSoundName()), packetIn.getCategory(), packetIn.func_186927_f(), packetIn.func_186928_g(), false, 0, ISound.AttenuationType.LINEAR, (float)packetIn.func_186932_c(), (float)packetIn.func_186926_d(), (float)packetIn.func_186925_e()));
    }
    ...
    public void handleCooldown(SPacketCooldown packetIn)
    {
        ...
        {
            this.gameController.thePlayer.func_184811_cZ().removeCooldown(packetIn.getItem());
        }
        else
        {
            this.gameController.thePlayer.func_184811_cZ().setCooldown(packetIn.getItem(), packetIn.getTicks());
        }
    }
    ...
    public void handleCustomPayload(SPacketCustomPayload packetIn)
    {
        ...
        else if ("MC|DebugPath".equals(packetIn.getChannelName()))
        {
            ...
            this.gameController.field_184132_p.field_188286_a.func_188289_a(j, pathentity, f);
        }
    }
    ...
    public void handleEntityProperties(SPacketEntityProperties packetIn)
    {
        ...
        if (entity != null)
        {
            ...
            else
            {
                ...
                {
                    IAttributeInstance iattributeinstance = abstractattributemap.getAttributeInstanceByName(spacketentityproperties$snapshot.func_151409_a());

                    if (iattributeinstance == null)
                    {
                        iattributeinstance = abstractattributemap.registerAttribute(new RangedAttribute((IAttribute)null, spacketentityproperties$snapshot.func_151409_a(), 0.0D, 2.2250738585072014E-308D, Double.MAX_VALUE));
                    }

                    iattributeinstance.setBaseValue(spacketentityproperties$snapshot.func_151410_b());
