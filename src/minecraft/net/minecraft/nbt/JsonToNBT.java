...
public class JsonToNBT
{
    ...
    static int topTagsCount(String p_150310_0_) throws NBTException
    {
        int i = 0;
        boolean flag = false;
        ...
        for (int j = 0; j < p_150310_0_.length(); ++j)
        {
            ...
            if (c0 == 34)
            {
                if (isCharEscaped(p_150310_0_, j))
                {
                    if (!flag)
                    {
    ...
    static JsonToNBT.Any joinStrToNBT(String... p_179272_0_) throws NBTException
    {
        return nameValueToNBT(p_179272_0_[0], p_179272_0_[1]);
    }

    static JsonToNBT.Any nameValueToNBT(String p_150316_0_, String p_150316_1_) throws NBTException
    {
        ...
        if (p_150316_1_.startsWith("{"))
        {
            ...
            {
                s1 = nextKeyNamePair(p_150316_1_, true);
        ...
        else if (p_150316_1_.startsWith("[") && !INT_ARRAY_MATCHER.matcher(p_150316_1_).matches())
        {
            ...
            {
                s = nextKeyNamePair(p_150316_1_, false);
    ...
    private static JsonToNBT.Any getTagFromNameValue(String p_179270_0_, boolean p_179270_1_) throws NBTException
    {
        String s = locateName(p_179270_0_, p_179270_1_);
        String s1 = locateValue(p_179270_0_, p_179270_1_);
        return joinStrToNBT(new String[] {s, s1});
    }

    private static String nextKeyNamePair(String p_150314_0_, boolean p_150314_1_) throws NBTException
    {
        int i = getNextCharIndex(p_150314_0_, ':');
        int j = getNextCharIndex(p_150314_0_, ',');
        ...
        return locateValueAt(p_150314_0_, i);
    }

    private static String locateValueAt(String p_179269_0_, int p_179269_1_) throws NBTException
    {
        Stack<Character> stack = new Stack();
        int i = p_179269_1_ + 1;
        boolean flag = false;
        ...
        for (int j = 0; i < p_179269_0_.length(); ++i)
        {
            ...
            if (c0 == 34)
            {
                if (isCharEscaped(p_179269_0_, i))
                {
                    if (!flag)
                    {
    ...
    private static String locateName(String p_150313_0_, boolean p_150313_1_) throws NBTException
    {
        if (p_150313_1_)
        {
        ...
        int i = getNextCharIndex(p_150313_0_, ':');
    ...
    private static String locateValue(String p_150311_0_, boolean p_150311_1_) throws NBTException
    {
        if (p_150311_1_)
        {
        ...
        int i = getNextCharIndex(p_150311_0_, ':');
    ...
    private static int getNextCharIndex(String p_150312_0_, char p_150312_1_)
    {
        int i = 0;
        ...
        for (boolean flag = true; i < p_150312_0_.length(); ++i)
        {
            ...
            if (c0 == 34)
            {
                if (!isCharEscaped(p_150312_0_, i))
                {
                    flag = !flag;
                }
            }
    ...
    private static boolean isCharEscaped(String p_179271_0_, int p_179271_1_)
    {
        return p_179271_1_ > 0 && p_179271_0_.charAt(p_179271_1_ - 1) == 92 && !isCharEscaped(p_179271_0_, p_179271_1_ - 1);
    }
