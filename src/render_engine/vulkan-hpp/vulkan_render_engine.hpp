...
namespace nova::renderer::rhi {
    struct VulkanMemoryHeap : vk::MemoryHeap {
        vk::DeviceSize amount_allocated = 0;
    };
...
#pragma endregion
    ...
    private:
         ...
         * buffer.
         */
        std::unordered_map<vk::DeviceMemory, void*> heap_mappings;
...
#pragma region Initialization
        ...
        static bool does_device_support_extensions(vk::PhysicalDevice device);
...
#pragma region Helpers
        ...
        [[nodiscard]] vk::ShaderModule create_shader_module(const std::vector<uint32_t>& spirv) const;
         ...
         */
        [[nodiscard]] vk::ImageView image_view_for_image(const Image* image);

        [[nodiscard]] static vk::CommandBufferLevel to_vk_command_buffer_level(const CommandList::Level level);
#pragma endregion

#pragma region Debugging
        vk::DebugUtilsMessengerEXT debug_callback{};

        static VKAPI_ATTR vk::Bool32 VKAPI_CALL debug_report_callback(vk::DebugUtilsMessageSeverityFlagBitsEXT messageSeverity,
