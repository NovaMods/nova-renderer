/*
    ...
    OpenGL loader generated by glad 0.1.33 on Sat Nov 16 06:40:26 2019.
    ...
    Commandline:
        --profile="compatibility" --api="gl=4.5" --generator="c" --spec="gl" --no-loader
   --extensions="GL_ARB_texture_filter_anisotropic,GL_NVX_gpu_memory_info,GL_NV_command_list,GL_NV_mesh_shader,GL_NV_shading_rate_image"
    Online:
        https://glad.dav1d.de/#profile=compatibility&language=c&specification=gl&api=gl%3D4.5&extensions=GL_ARB_texture_filter_anisotropic&extensions=GL_NVX_gpu_memory_info&extensions=GL_NV_command_list&extensions=GL_NV_mesh_shader&extensions=GL_NV_shading_rate_image
*/
...
typedef void(APIENTRYP PFNGLLISTDRAWCOMMANDSSTATESCLIENTNVPROC)(
    GLuint list, GLuint segment, const void** indirects, const GLsizei* sizes, const GLuint* states, const GLuint* fbos, GLuint count);
