...
namespace nova::renderer {
    ...
    class struct_uniform_buffer : public uniform_buffer {
    public:
        struct_uniform_buffer(std::string name, VkDevice device, VmaAllocator allocator, VkBufferCreateInfo& create_info, uint64_t alignment) : uniform_buffer(name, device, allocator, create_info, alignment) {
